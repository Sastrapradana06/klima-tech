    ...
    <div className="w-full h-max  mt-20 lg:mt-[7rem]">
      <div className="w-[90%] h-[400px] m-auto  flex flex-col f gap-6  pt-1 lg:pt-14 lg:items-center lg:flex-row-reverse lg:w-[85%]">
        ...
        <div className="w-full  h-max flex flex-col gap-4 lg:w-[50%]">
          ...
          <p className="text-gray-600 text-[.9rem] lg:text-[1rem]">
            Unlock your digital potential with our expert web development
            services. From digital invitation websites to landing pages and
            academic assignments, we provide tailored solutions to meet your
            needs.
          </p>
